...
/* Private defines -----------------------------------------------------------*/
#define KNX_TX_Pin GPIO_PIN_1
#define KNX_TX_GPIO_Port GPIOA
#define DEBUG_TX_Pin GPIO_PIN_2
#define DEBUG_TX_GPIO_Port GPIOA
#define KNX_RX_TIM_Pin GPIO_PIN_5
#define KNX_RX_TIM_GPIO_Port GPIOA
#define KNX_RX_IT_Pin GPIO_PIN_9
#define KNX_RX_IT_GPIO_Port GPIOA
#define KNX_RX_IT_EXTI_IRQn EXTI9_5_IRQn
